...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Đăng nhập",
      description: "Người quản trị sẽ cấp tài khoản cho bạn để đăng nhập"
    },
    {
      heading: "Quản lý thiết bị",
      description: "Hệ thống giúp bạn dễ dàng quản lý danh sách thiết bị"
    },
    {
      heading: "Xem thông số",
      description: "Xem chi tiết thông tin từ thiết bị gửi về"
    }
  ];
